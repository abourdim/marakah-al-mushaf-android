# Play Store listing — Marakah al-Mushaf (معركة المصحف)
...
- **Package name**: `org.workshopdiy.marakahalmushaf`
...
```
كتاب "معركة المصحف" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
📖 معركة المصحف — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "معركة المصحف" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "معركة المصحف" — الشيخ محمد الغزالي
...
### App name
```
Marakah al-Mushaf — Battle of the Quran
```

### Short description
```
"Battle of the Quran" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "Battle of the Quran" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "Battle of the Quran" — Sheikh Mohammed al-Ghazali
...
### App name
```
Marakah al-Mushaf — Marakah al-Mushaf
```

### Short description
```
« Battle of the Quran » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « Battle of the Quran » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « Battle of the Quran » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Marakah al-Mushaf
Last updated: 2026-04-26

The Marakah al-Mushaf app does not collect, store, transmit, or share any personal
